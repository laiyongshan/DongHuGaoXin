...
public abstract class FileCallback implements Callback<ResponseBody>{
    ...
    public File saveFile(Response<ResponseBody> response) throws Exception {
        ...
        int len;
        try {
//             String  destFileDir = Environment.getExternalStorageDirectory().getAbsolutePath() + File.separator + "hjo";// M_DEFAULT_DIR
//            String sdpath = Environment.getExternalStorageDirectory() + "/";
//            String pathURL = sdpath + "download";
...
///storage/emulated/0/download/suncere.apk
