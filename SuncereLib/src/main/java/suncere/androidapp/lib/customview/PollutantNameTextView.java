...
import suncere.androidapp.lib.utils.Convert;


public class PollutantNameTextView extends android.support.v7.widget.AppCompatTextView {
	...
	public void setText(String text)
	{
		...
		super.setText( this.ConvertPollutantAndUnitText( exceptChinese(text) ) );
	}
	...
	//去除中文字段
	public  String exceptChinese(String str){

//		if(!str.equals("臭氧1小时") || !str.equals("臭氧8小时")){
