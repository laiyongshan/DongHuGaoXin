...
public class StationSelectView extends LinearLayout {
    ...
    public StationSelectView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,0);
    }

    public StationSelectView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
...
//        Log.e("hjo","mpollutantstextSize="+mpollutantstextSize);
        ta.recycle();
...
//        this.setOrientation(LinearLayout.HORIZONTAL);
        ...
        for (int i=0;i< mPollutantsTexts.length;i++){
            ...
            textView.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mPollutantsCodes!=null){ //(int) v.getTag()
                        mSelceTextListener.onSelect(mPollutantsTexts[(int) v.getTag()],mPollutantsCodes[(int) v.getTag()],0);
                    }else{
                        mSelceTextListener.onSelect(mPollutantsTexts[(int) v.getTag()],null,(int) v.getTag());
                    }
    ...
    public interface  SelceTextListener {
        void onSelect(String pollutantName, String pollutantCode, int index);
    }
