...
public class SegmentControl extends View {
    ...
    public SegmentControl(Context context, AttributeSet attrs, int defStyle){
        ...
        backgroundColor=ta.getColor(R.styleable.segmentcontrol_backgroundColor, Color.TRANSPARENT);
        ...
        selectedTextColor=ta.getColor(R.styleable.segmentcontrol_selectTextColor,Color.WHITE);
        unselectedTextColor=ta.getColor(R.styleable.segmentcontrol_unselectTextColor,Color.BLACK);
