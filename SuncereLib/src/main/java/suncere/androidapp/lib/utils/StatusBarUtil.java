...
public class StatusBarUtil {
     ...
     * @return
     */
    public static  int getBottomStatusPxHeight(Context context){
        int totalHeight = getDpi(context);
        int contentHeight = getScreenHeight(context);
        return dp2px(totalHeight  - contentHeight);
    }


    /** dp转化为px工具 */
    public static int dp2px(float dp) {
        return (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, dp, MyApplication.getMyApplicationContext().getResources().getDisplayMetrics());
    }
    /**
     * 获得屏幕高度
     *
